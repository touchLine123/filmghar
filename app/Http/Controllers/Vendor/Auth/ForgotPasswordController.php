...
class ForgotPasswordController extends Controller {
    ...
    public function showLinkRequestForm() {
        ...
        return view('vendor.auth.passwords.email', compact('pageTitle'));
    }
    ...
    public function sendResetCodeEmail(Request $request) {
        ...
        return to_route('vendor.password.code.verify');
    }
    ...
    public function codeVerify() {
        ...
        return view('vendor.auth.passwords.code_verify', compact('pageTitle', 'email'));
    }
