...
class DepositController extends Controller {
    public function pending($userId = null) {
        ...
        return view('vendor.deposit.log', compact('pageTitle', 'deposits'));
    }
    ...
    public function deposit($userId = null) {
        ...
        return view('vendor.deposit.log', compact('pageTitle', 'deposits', 'successful', 'pending', 'rejected', 'initiated'));
    }
    ...
    public function details($id) {
        ...
        return view('vendor.deposit.detail', compact('pageTitle', 'deposit', 'details'));
    }
    ...
    public function approve($id) {
        ...
        return to_route('vendor.deposit.pending')->withNotify($notify);
    }
