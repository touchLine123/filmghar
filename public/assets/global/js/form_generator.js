  ...
  makeFormHtml(formItem, updateId) {
    ...
    var formsHtml = `
            ...
            <div class="form-field">
                ...
                <div class="form-field__item">
                    <button type="button" class="btn btn--primary btn--sm editFormData" data-form_item='${JSON.stringify(
                      formItem
                    )}' data-update_id="${updateId}"><i class="las la-pen me-0"></i></button>
