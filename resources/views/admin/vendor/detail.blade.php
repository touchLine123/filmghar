    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <a href="{{ route('admin.vendors.notification.log', $user->id) }}" class="btn btn--secondary btn--shadow w-100 btn-lg">
                ...
                @if ($user->kyc_data)
                    <div class="flex-fill">
                        <a href="{{ route('admin.vendors.kyc.details', $user->id) }}" target="_blank" class="btn btn--dark btn--shadow w-100 btn-lg">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="firstname" required value="{{ $nameParts[0] ?? '' }} ">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lastname" required value="{{ $nameParts[1] ?? '' }} ">
                                </div>
                            </div>
                                    ...
                                    <select name="country" class="form-control select2">
                                        @foreach ($countries as $key => $country)
                                            <option 
                                                ...
                                                value="{{ $key }}" 
                                                @selected(old('country', $user->country_code ?? 'NP') == $key)>
                                                {{ __($country->country) }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                           data-bs-toggle="toggle" data-on="@lang('Active')" data-off="@lang('Inactive')" name="status" value="1"
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="number" min="0" name="commission" value="{{ @$user->commission }}">
                                </div>
                            </div>
