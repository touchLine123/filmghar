            ...
            <div class="row account-area align-items-center justify-content-center">
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8">
                    <div class="account-form-area @if (!gs('registration')) form-disabled @endif">
                        ...
                        <form class="account-form verify-gcaptcha" action="{{ route('vendor.register') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                        ...
                        <div class="text-center mt-3">
                            <span class="fs-12">@lang('Already Have An Account?') <a class="text--base" href="{{ route('login') }}">@lang('Login Now')</a></span>
                        </div>
                    </div>
                </div>
            </div>
