...
@section('panel')
    ...
    <div class="row mt-2 gy-4">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-card-wrapper">
                        ...
                        <div class="widget-card bg--success">
                            <a href="{{ route('vendor.deposit.list') }}" class="widget-card-link"></a>
                        ...
                        <div class="widget-card bg--info">
                            <a href="{{ route('vendor.deposit.pending') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-wallet"></i>
                                </div>
                        ...
                        <div class="widget-card bg--warning">
                            <a href="{{ route('vendor.deposit.rejected') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                        ...
                        <div class="widget-card bg--primary">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Paymented Charge')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    <h5 class="card-title">@lang('Items')</h5>
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--success">
                            <a href="{{ route('vendor.item.index') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-film"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $item['total'] }}</h6>
                                    <p class="widget-card-title">@lang('Total Items')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--warning">
                            <a href="{{ route('vendor.item.single') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-video"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $item['single'] }}</h6>
                                    <p class="widget-card-title">@lang('Single Items')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--danger">
                            <a href="{{ route('vendor.item.episode') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-play-circle"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $item['episode'] }}</h6>
                                    <p class="widget-card-title">@lang('Episode Items')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--primary">
                            <a href="{{ route('vendor.item.trailer') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-photo-video"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $item['trailer'] }}</h6>
                                    <p class="widget-card-title">@lang('Trailer Items')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
...
@push('script')
    <script>
        ...
        const depositWithdrawChart = (startDate, endDate) => {
            ...
            const url = @json(route('chart.deposit.withdraw'));
