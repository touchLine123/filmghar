...
@section('panel')
    <div class="row justify-content-center">
        @if (request()->routeIs('vendor.deposit.list') || request()->routeIs('vendor.deposit.method'))
            <div class="col-12">
                @include('vendor.deposit.widget')
            </div>
        @endif
                            ...
                            <tbody>
                                @forelse($deposits as $deposit)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('vendor.deposit.details', $deposit->id) }}"
