                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                <button class="btn btn--sm btn-outline--danger confirmationBtn" data-question="@lang('Are you sure to remove this subtitle?')" data-action="{{ route('vendor.item.subtitle.delete', $subtitle->id) }}"><i class="la la-trash"></i>@lang('Delete')</button>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
    ...
    <script>
        (function($) {
            ...
            $('.addBtn').on('click', function(e) {
                ...
                modal.find('form').attr('action', `{{ route('vendor.item.subtitle.store', [$itemId, $episodeId, $videoId]) }}`);
                modal.modal('show');
            });
            ...
            $('.editBtn').on('click', function(e) {
                ...
                modal.find('form').attr('action', `{{ route('vendor.item.subtitle.store', [$itemId, $episodeId, $videoId]) }}/${subtitle.id}`);
