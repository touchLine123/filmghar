...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('vendor.item.update', $item->id) }}" method="post" enctype="multipart/form-data" id="itemForm">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
...
@push('breadcrumb-plugins')
    <a class="btn btn--sm btn-outline--primary" href="{{ route('vendor.item.index') }}"><i class="la la-undo"></i> @lang('Back')</a>
@endpush
